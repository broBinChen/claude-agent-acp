    ...
    canUseTool(sessionId) {
        return async (toolName, toolInput, { signal, suggestions, toolUseID }) => {
            ...
            if (toolName === "AskUserQuestion") {
                ...
                const supportsFormElicitation = this.clientCapabilities?.elicitation?.form != null;
                if (!supportsFormElicitation) {
                    return {
                        behavior: "deny",
                        message: "Client does not advertise elicitation.form capability — " +
                ...
                if (resp.action === "accept") {
                    return {
                        ...
                        updatedInput: {
                            questions,
                            answers: contentToAnswers(resp.content, questions),
                        },
                    };
                }
